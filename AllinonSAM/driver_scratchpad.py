...
source_path = os.path.join("/home/abdelrahman.elsayed/med-cvpr/AllinonSAM/datasets")
...
def parse_args():
    ...
    parser.add_argument(
        "--data_config",
        default="/home/abdelrahman.elsayed/med-cvpr/AllinonSAM/config_arcade.yml",
        help="data config file path",
    )

    parser.add_argument(
        "--model_config",
        default="/home/abdelrahman.elsayed/med-cvpr/AllinonSAM/model_svdtuning.yml",
